  ...
  return (
    <>
      <div className="main w-[300px] h-[250px] border-[1.7px] border-[#FFBF13]  rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] items-center">
            <div className='text-center font-semibold text-white mt-10 text-4xl '>{count}</div>
            ...
            <button onClick={Remove} className='font-semibold bg-[#fdfaf3] py-3 px-5 rounded-xl text-[#bc6b4d] items-center ml-3 hover:bg-[#a55e6277] duration-700'>Remove</button>
            </div>
      </div>
    </>
  )
